...
import { logout, updateLoggedUser } from "../slices/authSlice"
import UserServices from "../services/userServices"
import { useAppDispatch } from "../app/hooks"
import { IEditUser } from "@internal/shared"
...
const EditUserModal: React.FC<Props> = ({
  ...
  const handleDeleteUser = () => {
    toastr.confirm("Are you sure?", {
      onOk: async () => {
        await UserServices.deleteUser(user._id.toString())
        ...
        toastr.success(
          isEditingProfile ? "Account deleted" : "User successfully deleted",
          ""
        )
        handleClose()
      }
